...
@register_keras_serializable(package="Custom", name="CBAM_ShortMLP")
class CBAM_ShortMLP(layers.Layer):
    def __init__(self, reduction=16, kernel_size=7, **kwargs):
        super(CBAM_ShortMLP, self).__init__(**kwargs)
    ...
    def get_config(self):
      config = super().get_config()  # Use apenas super()
      config.update({
